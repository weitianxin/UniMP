...
# Baby Beauty Clothing Grocery  Office Sports Tools Toys
# "Electronics"
...
# "Grocery and Gourmet Food", "Tools and Home Improvement"
...
# data_names = ["Beauty"]
data_names = ["Tools and Home Improvement"]
process_dir = "processed_filter_5_tool"
save_name = "tool"
...
training_sequences = filter_Kcore(training_sequences, user_core=6, item_core=5)
